...
def main(lan):
    ...
    mark_setups = get_mark_setups_for_dir("/mnt/disk4/ChatGPT-SCG-Supplementary/CWE-2")
    ...
    for mark_setup in mark_setups:
        ...
        db_name = "codeql-db"
        results_csv_name = config2.INTERMEDIATE_RESULT_FILE
        ...
        if mark_setup['language'] == 'python' and (lan == 'py' or True) and mark_setup['cwe'] == 'CWE-798' and True:
        ...
        elif mark_setup['language'] == 'c' and (lan == 'c' or True) and mark_setup['cwe'] == 'CWE-798' and True:
